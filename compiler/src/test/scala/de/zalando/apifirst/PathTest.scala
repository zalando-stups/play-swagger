...
class PathTest extends FunSpec with MustMatchers {
  ...
  describe("Path") {
    ...
    it("should convert in-path parameters") {
      ...
      a.interpolated mustBe "/${a}"
      a.prepend("/echo/").interpolated  mustBe "/echo/${a}"
      a.prepend("/echo").interpolated   mustBe "/echo/${a}"
      a.asPlay mustBe "/:a"
    ...
    it("should convert in-path parameters with trailing slash") {
      ...
      a.interpolated mustBe "/a/${a}/"
      a.prepend("/echo/").interpolated  mustBe "/echo/a/${a}/"
      a.prepend("/echo").interpolated   mustBe "/echo/a/${a}/"
      a.asPlay mustBe "/a/:a/"
    ...
    it("should convert multiple in-path parameters") {
      ...
      a.interpolated mustBe "/a/${b}/${c}/d/${e}"
      a.prepend("/echo/").interpolated  mustBe "/echo/a/${b}/${c}/d/${e}"
      a.prepend("/echo").interpolated   mustBe "/echo/a/${b}/${c}/d/${e}"
