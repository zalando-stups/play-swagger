...
class Rfc3339UtilTest extends FunSpec with MustMatchers {
  ...
  describe("Rfc3339UtilTest") {
    ...
    it("should parse RFC3339 DateTime") {
      Rfc3339Util.parseDateTime("2007-05-01T15:43:26-07:00").withZone(dtz).toString mustBe "2007-05-01T22:43:26.000Z"
      Rfc3339Util.parseDateTime("2007-05-01T15:43:26.3-07:00").withZone(dtz).toString mustBe "2007-05-01T22:43:26.300Z"
      Rfc3339Util.parseDateTime("2007-05-01T15:43:26.3452-07:00").withZone(dtz).toString mustBe "2007-05-01T22:43:26.345Z"
      Rfc3339Util.parseDateTime("2007-05-01T15:43:26.3452Z").withZone(dtz).toString mustBe "2007-05-01T13:43:26.345Z"
      Rfc3339Util.parseDateTime("2007-05-01T15:43:26.3Z").withZone(dtz).toString mustBe "2007-05-01T13:43:26.300Z"
      Rfc3339Util.parseDateTime("2007-05-01T15:43:26Z").withZone(dtz).toString mustBe "2007-05-01T13:43:26.000Z"
    }
