...
import java.io.File
    ...
    case class User(website: LikeUser_name, 
profile_picture: LikeUser_name, 
username: LikeUser_name, 
full_name: LikeUser_name, 
bio: LikeUser_name, 
id: MediaCreated_time, 
counts: UserCounts
) 

    case class Image(width: MediaCreated_time, 
height: MediaCreated_time, 
url: LikeUser_name
) 

    case class Tag(media_count: MediaCreated_time, 
name: LikeUser_name
) 

    case class Comment(id: LikeUser_name, 
created_time: LikeUser_name, 
text: LikeUser_name, 
from: MediaUser
) 

    case class Media(location: MediaLocation, 
created_time: MediaCreated_time, 
`comments:`: `MediaComments:`, 
tags: MediaTags, 
users_in_photo: MediaUsers_in_photo, 
filter: LikeUser_name, 
likes: MediaLikes, 
id: MediaCreated_time, 
videos: MediaVideos, 
`type`: LikeUser_name, 
...
user: MediaUser
    ...
    case class MediaVideosOpt(low_resolution: MediaVideosLow_resolution, 
standard_resolution: MediaVideosLow_resolution
) 

    case class Like(first_name: LikeUser_name, 
id: LikeUser_name, 
last_name: LikeUser_name, 
`type`: LikeUser_name, 
user_name: LikeUser_name
) 

    case class MediaLikesOpt(count: MediaCreated_time, 
data: MediaUsers_in_photo
) 

    case class Location(id: LikeUser_name, 
name: LikeUser_name, 
latitude: LocationLongitude, 
longitude: LocationLongitude
) 

    case class MiniProfile(user_name: LikeUser_name, 
full_name: LikeUser_name, 
id: MediaCreated_time, 
profile_picture: LikeUser_name
) 

    case class MediaImagesOpt(low_resolution: MediaVideosLow_resolution, 
thumbnail: MediaVideosLow_resolution, 
standard_resolution: MediaVideosLow_resolution
) 

    case class UserCountsOpt(media: MediaCreated_time, 
follows: MediaCreated_time, 
follwed_by: MediaCreated_time
) 

    case class `MediaComments:Opt`(count: MediaCreated_time, 
data: `MediaComments:Data`
) 
    ...
    case class `MediaMedia-idLikesGetResponses200Opt`(meta: `MediaMedia-idCommentsDeleteResponses200Meta`, 
data: `MediaMedia-idLikesGetResponses200Data`
) 

    case class `UsersSelfRequested-byGetResponses200Opt`(meta: TagsSearchGetResponses200Meta, 
data: MediaUsers_in_photo
) 
    ...
    case class TagsSearchGetResponses200Opt(meta: TagsSearchGetResponses200Meta, 
data: MediaTags
) 
    ...
    case class MediaSearchGetResponses200DataOptArr(location: MediaLocation, 
created_time: MediaCreated_time, 
`comments:`: `MediaComments:`, 
tags: MediaTags, 
users_in_photo: MediaUsers_in_photo, 
...
images: MediaImages, 
user: MediaUser, 
distance: LocationLongitude
) 

    case class `MediaMedia-idLikesPostResponses200Opt`(meta: `MediaMedia-idCommentsDeleteResponses200Meta`, 
data: LikeUser_name
) 
    ...
    case class `MediaMedia-idCommentsGetResponses200Opt`(meta: `MediaMedia-idCommentsDeleteResponses200Meta`, 
data: `MediaComments:Data`
) 
