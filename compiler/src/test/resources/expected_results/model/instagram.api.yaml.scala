...
type TagsSearchGetResponses200Meta = Option[`UsersSelfRequested-byGetResponses200MetaOpt`]
    ...
    type `UsersUser-idFollowsGetResponses200` = Option[`UsersUser-idFollowsGetResponses200Opt`]
    ...
    case class `MediaMedia-idCommentsDeleteResponses200Opt`(meta: `MediaMedia-idCommentsDeleteResponses200Meta`, data: LikeUser_name) 

    case class UsersSelfFeedGetResponses200Opt(data: UsersSelfFeedGetResponses200Data) 
    ...
    case class `UsersUser-idFollowsGetResponses200Opt`(data: MediaUsers_in_photo) 
