...
object paths {
    ...
    type `MediaMedia-iCommentsPostResponses200Data` = Option[`MediaMedia-iLikesDeleteResponses200DataOpt`]
    ...
    case class `MediaMedia-iLikesDeleteResponses200DataOpt`() 
    ...
    case class `MediaMedia-iLikesPostResponses200Opt`(meta: `MediaMedia-iCommentsDeleteResponses200Meta`, data: `MediaMedia-iCommentsPostResponses200Data`) 
