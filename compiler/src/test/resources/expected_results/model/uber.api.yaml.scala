...
import java.io.File
    ...
    case class PriceEstimate(low_estimate: PriceEstimateLow_estimate, 
display_name: ProfileLast_name, 
estimate: ProfileLast_name, 
high_estimate: PriceEstimateLow_estimate, 
product_id: ProfileLast_name, 
currency_code: ProfileLast_name, 
surge_multiplier: PriceEstimateLow_estimate
) 

    case class Product(image: ProfileLast_name, 
description: ProfileLast_name, 
display_name: ProfileLast_name, 
product_id: ProfileLast_name, 
capacity: ProfileLast_name
) 

    case class Profile(first_name: ProfileLast_name, 
email: ProfileLast_name, 
promo_code: ProfileLast_name, 
last_name: ProfileLast_name, 
picture: ProfileLast_name
) 

    case class Activities(offset: ActivitiesLimit, 
limit: ActivitiesLimit, 
count: ActivitiesLimit, 
history: ActivitiesHistory
) 

    case class Error(code: ActivitiesLimit, 
message: ProfileLast_name, 
fields: ProfileLast_name
) 
