...
trait NakadiYamlBase extends Controller with PlayBodyParsing {
    ...
    def nakadiHackGet_metricsAction = (f: nakadiHackGet_metricsActionType) => Action {        val nakadiHackGet_metricsResponseMimeType    = "application/json"
    ...
    def nakadiHackGet_partitionAction = (f: nakadiHackGet_partitionActionType) => (topic: String, partition: String) => Action {        val nakadiHackGet_partitionResponseMimeType    = "application/json"
    ...
    def nakadiHackGet_topicsAction = (f: nakadiHackGet_topicsActionType) => Action {        val nakadiHackGet_topicsResponseMimeType    = "application/json"
    ...
    def nakadiHackPost_eventAction = (f: nakadiHackPost_eventActionType) => (topic: String) => Action(nakadiHackPost_eventParser()) { request =>        val nakadiHackPost_eventResponseMimeType    = "application/json"
    ...
    def nakadiHackGet_partitionsAction = (f: nakadiHackGet_partitionsActionType) => (topic: String) => Action {        val nakadiHackGet_partitionsResponseMimeType    = "application/json"
    ...
    def nakadiHackPost_eventsAction = (f: nakadiHackPost_eventsActionType) => (topic: String) => Action(nakadiHackPost_eventsParser()) { request =>        val nakadiHackPost_eventsResponseMimeType    = "application/json"
