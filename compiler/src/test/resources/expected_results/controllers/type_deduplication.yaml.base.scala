...
trait Type_deduplicationYamlBase extends Controller with PlayBodyParsing {
    sealed trait getplantsByPlant_idWateringsByWatering_idType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_idWateringsByWatering_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends getplantsByPlant_idWateringsByWatering_idType[Error] { val statusCode = 404 }
    case class getplantsByPlant_idWateringsByWatering_id200(result: Watering)(implicit val writers: List[Writeable[Watering]]) extends getplantsByPlant_idWateringsByWatering_idType[Watering] { val statusCode = 200 }
    ...
    sealed trait putplantsByPlant_idWateringsByWatering_idType[Result] extends ResultWrapper[Result]
    case class putplantsByPlant_idWateringsByWatering_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends putplantsByPlant_idWateringsByWatering_idType[Error] { val statusCode = 404 }
    case class putplantsByPlant_idWateringsByWatering_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idWateringsByWatering_idType[Null] { val statusCode = 200 }
    case class putplantsByPlant_idWateringsByWatering_id201(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idWateringsByWatering_idType[Null] { val statusCode = 201 }
    ...
    sealed trait getusersMeType[Result] extends ResultWrapper[Result]
    case class getusersMe200(result: User)(implicit val writers: List[Writeable[User]]) extends getusersMeType[User] { val statusCode = 200 }
    ...
    sealed trait getplantsByPlant_idSunlight_needsType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_idSunlight_needs404(result: Null)(implicit val writers: List[Writeable[Null]]) extends getplantsByPlant_idSunlight_needsType[Null] { val statusCode = 404 }
    case class getplantsByPlant_idSunlight_needs200(result: SunlightNeeds)(implicit val writers: List[Writeable[SunlightNeeds]]) extends getplantsByPlant_idSunlight_needsType[SunlightNeeds] { val statusCode = 200 }
    ...
    sealed trait putplantsByPlant_idSunlight_needsType[Result] extends ResultWrapper[Result]
    case class putplantsByPlant_idSunlight_needs200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idSunlight_needsType[Null] { val statusCode = 200 }
    case class putplantsByPlant_idSunlight_needs404(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idSunlight_needsType[Null] { val statusCode = 404 }
    ...
    sealed trait getusersType[Result] extends ResultWrapper[Result]
    case class getusers200(result: Seq[User])(implicit val writers: List[Writeable[Seq[User]]]) extends getusersType[Seq[User]] { val statusCode = 200 }
    ...
    def getusersAction[T] = (f: getusersActionType[T]) => (limit: ErrorCode, offset: ErrorCode) => getusersActionConstructor { request =>
        val providedTypes = Seq[String]("application/json")
    ...
    sealed trait postusersType[Result] extends ResultWrapper[Result]
    case class postusers200(result: Null)(implicit val writers: List[Writeable[Null]]) extends postusersType[Null] { val statusCode = 200 }
    ...
    sealed trait getareasByArea_idType[Result] extends ResultWrapper[Result]
    case class getareasByArea_id200(result: Area)(implicit val writers: List[Writeable[Area]]) extends getareasByArea_idType[Area] { val statusCode = 200 }
    ...
    sealed trait putareasByArea_idType[Result] extends ResultWrapper[Result]
    case class putareasByArea_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putareasByArea_idType[Null] { val statusCode = 200 }
    case class putareasByArea_id201(result: Null)(implicit val writers: List[Writeable[Null]]) extends putareasByArea_idType[Null] { val statusCode = 201 }
    ...
    sealed trait deleteareasByArea_idType[Result] extends ResultWrapper[Result]
    case class deleteareasByArea_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends deleteareasByArea_idType[Null] { val statusCode = 200 }
    ...
    sealed trait getplantsType[Result] extends ResultWrapper[Result]
    case class getplants200(result: Seq[Plant])(implicit val writers: List[Writeable[Seq[Plant]]]) extends getplantsType[Seq[Plant]] { val statusCode = 200 }
    ...
    sealed trait getuserByUser_idPlantsType[Result] extends ResultWrapper[Result]
    case class getuserByUser_idPlants404(result: Null)(implicit val writers: List[Writeable[Null]]) extends getuserByUser_idPlantsType[Null] { val statusCode = 404 }
    case class getuserByUser_idPlants200(result: Seq[Plant])(implicit val writers: List[Writeable[Seq[Plant]]]) extends getuserByUser_idPlantsType[Seq[Plant]] { val statusCode = 200 }
    ...
    def getuserByUser_idPlantsAction[T] = (f: getuserByUser_idPlantsActionType[T]) => (user_id: String, limit: ErrorCode, offset: ErrorCode) => getuserByUser_idPlantsActionConstructor { request =>
        val providedTypes = Seq[String]("application/json")
    ...
    case class getusersByUser_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends getusersByUser_idType[Error] { val statusCode = 404 }
    case class getusersByUser_id200(result: User)(implicit val writers: List[Writeable[User]]) extends getusersByUser_idType[User] { val statusCode = 200 }
    ...
    sealed trait putusersByUser_idType[Result] extends ResultWrapper[Result]
    case class putusersByUser_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putusersByUser_idType[Null] { val statusCode = 200 }
    case class putusersByUser_id201(result: Null)(implicit val writers: List[Writeable[Null]]) extends putusersByUser_idType[Null] { val statusCode = 201 }
    ...
    sealed trait deleteusersByUser_idType[Result] extends ResultWrapper[Result]
    case class deleteusersByUser_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends deleteusersByUser_idType[Error] { val statusCode = 404 }
    case class deleteusersByUser_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends deleteusersByUser_idType[Null] { val statusCode = 200 }
    ...
    sealed trait getareasType[Result] extends ResultWrapper[Result]
    case class getareas200(result: Seq[Area])(implicit val writers: List[Writeable[Seq[Area]]]) extends getareasType[Seq[Area]] { val statusCode = 200 }
    ...
    def getareasAction[T] = (f: getareasActionType[T]) => (limit: ErrorCode, offset: ErrorCode) => getareasActionConstructor { request =>
        val providedTypes = Seq[String]("application/json")
    ...
    sealed trait getplantsByPlant_idLocationType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_idLocation404(result: Null)(implicit val writers: List[Writeable[Null]]) extends getplantsByPlant_idLocationType[Null] { val statusCode = 404 }
    case class getplantsByPlant_idLocation200(result: Location)(implicit val writers: List[Writeable[Location]]) extends getplantsByPlant_idLocationType[Location] { val statusCode = 200 }
    ...
    sealed trait putplantsByPlant_idLocationType[Result] extends ResultWrapper[Result]
    case class putplantsByPlant_idLocation200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idLocationType[Null] { val statusCode = 200 }
    case class putplantsByPlant_idLocation404(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idLocationType[Null] { val statusCode = 404 }
    ...
    sealed trait deleteplantsByPlant_idLocationType[Result] extends ResultWrapper[Result]
    case class deleteplantsByPlant_idLocation200(result: Null)(implicit val writers: List[Writeable[Null]]) extends deleteplantsByPlant_idLocationType[Null] { val statusCode = 200 }
    case class deleteplantsByPlant_idLocation404(result: Null)(implicit val writers: List[Writeable[Null]]) extends deleteplantsByPlant_idLocationType[Null] { val statusCode = 404 }
    ...
    sealed trait getusersByUser_idPictureType[Result] extends ResultWrapper[Result]
    case class getusersByUser_idPicture404(result: Error)(implicit val writers: List[Writeable[Error]]) extends getusersByUser_idPictureType[Error] { val statusCode = 404 }
    case class getusersByUser_idPicture200(result: Null)(implicit val writers: List[Writeable[Null]]) extends getusersByUser_idPictureType[Null] { val statusCode = 200 }
    ...
    sealed trait putusersByUser_idPictureType[Result] extends ResultWrapper[Result]
    case class putusersByUser_idPicture404(result: Error)(implicit val writers: List[Writeable[Error]]) extends putusersByUser_idPictureType[Error] { val statusCode = 404 }
    case class putusersByUser_idPicture200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putusersByUser_idPictureType[Null] { val statusCode = 200 }
    case class putusersByUser_idPicture201(result: Null)(implicit val writers: List[Writeable[Null]]) extends putusersByUser_idPictureType[Null] { val statusCode = 201 }
    ...
    sealed trait deleteusersByUser_idPictureType[Result] extends ResultWrapper[Result]
    case class deleteusersByUser_idPicture404(result: Error)(implicit val writers: List[Writeable[Error]]) extends deleteusersByUser_idPictureType[Error] { val statusCode = 404 }
    case class deleteusersByUser_idPicture200(result: Null)(implicit val writers: List[Writeable[Null]]) extends deleteusersByUser_idPictureType[Null] { val statusCode = 200 }
    ...
    sealed trait getplantsByPlant_idPicturesType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_idPictures200(result: Seq[String])(implicit val writers: List[Writeable[Seq[String]]]) extends getplantsByPlant_idPicturesType[Seq[String]] { val statusCode = 200 }
    case class getplantsByPlant_idPictures404(result: Null)(implicit val writers: List[Writeable[Null]]) extends getplantsByPlant_idPicturesType[Null] { val statusCode = 404 }
    ...
    def getplantsByPlant_idPicturesAction[T] = (f: getplantsByPlant_idPicturesActionType[T]) => (plant_id: String, limit: ErrorCode, offset: ErrorCode) => getplantsByPlant_idPicturesActionConstructor { request =>
        val providedTypes = Seq[String]("application/json")
    ...
    sealed trait getplantsByPlant_idType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends getplantsByPlant_idType[Error] { val statusCode = 404 }
    case class getplantsByPlant_id200(result: Plant)(implicit val writers: List[Writeable[Plant]]) extends getplantsByPlant_idType[Plant] { val statusCode = 200 }
    ...
    sealed trait putplantsByPlant_idType[Result] extends ResultWrapper[Result]
    case class putplantsByPlant_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idType[Null] { val statusCode = 200 }
    case class putplantsByPlant_id201(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idType[Null] { val statusCode = 201 }
    case class putplantsByPlant_id404(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idType[Null] { val statusCode = 404 }
    ...
    sealed trait deleteplantsByPlant_idType[Result] extends ResultWrapper[Result]
    case class deleteplantsByPlant_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends deleteplantsByPlant_idType[Error] { val statusCode = 404 }
    case class deleteplantsByPlant_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends deleteplantsByPlant_idType[Null] { val statusCode = 200 }
    ...
    sealed trait getplantsByPlant_idWateringsType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_idWaterings200(result: Seq[Watering])(implicit val writers: List[Writeable[Seq[Watering]]]) extends getplantsByPlant_idWateringsType[Seq[Watering]] { val statusCode = 200 }
    case class getplantsByPlant_idWaterings404(result: Null)(implicit val writers: List[Writeable[Null]]) extends getplantsByPlant_idWateringsType[Null] { val statusCode = 404 }
    ...
    def getplantsByPlant_idWateringsAction[T] = (f: getplantsByPlant_idWateringsActionType[T]) => (plant_id: String, limit: ErrorCode, offset: ErrorCode) => getplantsByPlant_idWateringsActionConstructor { request =>
        val providedTypes = Seq[String]("application/json")
    ...
    sealed trait getplantsByPlant_idPicturesByPicture_idType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_idPicturesByPicture_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends getplantsByPlant_idPicturesByPicture_idType[Error] { val statusCode = 404 }
    case class getplantsByPlant_idPicturesByPicture_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends getplantsByPlant_idPicturesByPicture_idType[Null] { val statusCode = 200 }
    ...
    sealed trait putplantsByPlant_idPicturesByPicture_idType[Result] extends ResultWrapper[Result]
    case class putplantsByPlant_idPicturesByPicture_id404(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idPicturesByPicture_idType[Null] { val statusCode = 404 }
    case class putplantsByPlant_idPicturesByPicture_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idPicturesByPicture_idType[Null] { val statusCode = 200 }
    case class putplantsByPlant_idPicturesByPicture_id201(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idPicturesByPicture_idType[Null] { val statusCode = 201 }
    ...
    sealed trait deleteplantsByPlant_idPicturesByPicture_idType[Result] extends ResultWrapper[Result]
    case class deleteplantsByPlant_idPicturesByPicture_id404(result: Error)(implicit val writers: List[Writeable[Error]]) extends deleteplantsByPlant_idPicturesByPicture_idType[Error] { val statusCode = 404 }
    case class deleteplantsByPlant_idPicturesByPicture_id200(result: Null)(implicit val writers: List[Writeable[Null]]) extends deleteplantsByPlant_idPicturesByPicture_idType[Null] { val statusCode = 200 }
    ...
    sealed trait getplantsByPlant_idWater_needsType[Result] extends ResultWrapper[Result]
    case class getplantsByPlant_idWater_needs200(result: WaterNeeds)(implicit val writers: List[Writeable[WaterNeeds]]) extends getplantsByPlant_idWater_needsType[WaterNeeds] { val statusCode = 200 }
    ...
    sealed trait putplantsByPlant_idWater_needsType[Result] extends ResultWrapper[Result]
    case class putplantsByPlant_idWater_needs200(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idWater_needsType[Null] { val statusCode = 200 }
    case class putplantsByPlant_idWater_needs404(result: Null)(implicit val writers: List[Writeable[Null]]) extends putplantsByPlant_idWater_needsType[Null] { val statusCode = 404 }
