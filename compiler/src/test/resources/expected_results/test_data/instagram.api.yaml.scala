...
object parametersGenerator {
    ...
    def `User-id-paramUser-idGenerator` = arbitrary[Double]

    def `Tag-nameTag-nameGenerator` = arbitrary[String]
...
object definitionsGenerator {
    ...
    def `MediaComments:OptGenerator` =
...
object pathsGenerator {
    ...
    def `createLocationsLocation-idMediaRecentGetResponses200DataOptGenerator` = _generate(`LocationsLocation-idMediaRecentGetResponses200DataOptGenerator`)
    ...
    def `LocationsLocation-idLocation-idGenerator` = arbitrary[Int]

    def UsersSelfFeedGetResponses200Generator = Gen.option(`UsersUser-idMediaRecentGetResponses200OptGenerator`)

    def `LocationsLocation-idMediaRecentGetResponses200DataGenerator` = Gen.option(`LocationsLocation-idMediaRecentGetResponses200DataOptGenerator`)

    def `MediaMedia-idCommentsDeleteResponses200MetaGenerator` = Gen.option(`MediaMedia-idCommentsPostResponses200MetaOptGenerator`)

    def `LocationsLocation-idMediaRecentGetResponses200DataOptGenerator` = Gen.containerOf[List,Media](MediaGenerator)

    def `MediaMedia-idLikesGetResponses200DataGenerator` = Gen.option(`MediaMedia-idLikesGetResponses200DataOptGenerator`)

    def `MediaMedia-idCommentsDeleteResponses200Generator` = Gen.option(`MediaMedia-idLikesPostResponses200OptGenerator`)

    def `UsersUser-idFollowsGetResponses200Generator` = Gen.option(`UsersUser-idRelationshipPostResponses200OptGenerator`)
    ...
    def `GeographiesGeo-idMediaRecentGetResponses200Generator` = arbitrary[Null]
    ...
    def `MediaMedia-idLikesGetResponses200OptGenerator` =
    ...
    def `UsersSelfRequested-byGetResponses200OptGenerator` =
    ...
    def `UsersUser-idRelationshipPostResponses200OptGenerator` =
    ...
    def `UsersUser-idMediaRecentGetResponses200OptGenerator` =
    ...
    def TagsSearchGetResponses200OptGenerator =
    ...
    def `TagsTag-nameMediaRecentGetResponses200OptGenerator` =
    ...
    def MediaSearchGetResponses200OptGenerator =
    ...
    def `MediaMedia-idCommentsPostResponses200MetaOptGenerator` =
    ...
    def `UsersSelfRequested-byGetResponses200MetaOptGenerator` =
    ...
    def MediaSearchGetResponses200DataOptArrGenerator =
    ...
    def `MediaMedia-idLikesPostResponses200OptGenerator` =
    ...
    def LocationsSearchGetResponses200OptGenerator =
    ...
    def `LocationsLocation-idGetResponses200OptGenerator` =
    ...
    def `UsersUser-idGetResponses200OptGenerator` =
    ...
    def `MediaMedia-idCommentsGetResponses200OptGenerator` =
