...
object definitionsGenerator {
    ...
    val MediaUsers_in_photoOptGenerator = Gen.containerOf[List,MiniProfile](MiniProfileGenerator)
    ...
    val MediaUsers_in_photoGenerator = Gen.option(MediaUsers_in_photoOptGenerator)
...
object pathsGenerator {
    ...
    val `LocationsLocation-idMediaRecentGetResponses200DataGenerator` = Gen.option(`LocationsLocation-idMediaRecentGetResponses200DataOptGenerator`)
    ...
    val `LocationsLocation-idMediaRecentGetResponses200DataOptGenerator` = Gen.containerOf[List,Media](MediaGenerator)
    ...
    val LocationsSearchGetResponses200DataGenerator = Gen.option(LocationsSearchGetResponses200DataOptGenerator)
    val `TagsTag-nameGetResponses200Generator` = Gen.option(TagGenerator)
    ...
    val LocationsSearchGetResponses200DataOptGenerator = Gen.containerOf[List,Location](LocationGenerator)
