...
object full_petstore_api_yaml extends WithModel {
 ...
 val types = Map[Reference, Type](
	...
	Reference("⌿definitions⌿Pet⌿category") → 
		Opt(TypeRef(Reference("⌿definitions⌿Tag")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{username}⌿get⌿username") → 
		Str(None, new TypeMeta(None, List())),
	Reference("⌿paths⌿/pets⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿definitions⌿Pet")), new TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/stores/order⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿definitions⌿Order")), new TypeMeta(None, List())),
	...
	Reference("⌿definitions⌿Pet⌿tags⌿Opt") → 
		Arr(TypeRef(Reference("⌿definitions⌿Tag")), new TypeMeta(None, List()), "csv"),
	...
	Reference("⌿paths⌿/users/createWithList⌿post⌿body⌿Opt") → 
		Arr(TypeRef(Reference("⌿definitions⌿User")), new TypeMeta(None, List()), "csv"),
...
val packageName: Option[String] = Some("full.petstore.api.yaml")
