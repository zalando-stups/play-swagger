...
object type_deduplication_yaml extends WithModel {
 ...
 val types = Map[Reference, Type](
	...
	Reference("⌿paths⌿/plants⌿get⌿limit") → 
		Opt(BInt(new TypeMeta(None, List("""min(BigInt("10"), false)"""))), new TypeMeta(None, List())),
	Reference("⌿paths⌿/plants⌿get⌿offset") → 
		Opt(BInt(new TypeMeta(None, List("""max(BigInt("100"), false)"""))), new TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/users⌿get⌿responses⌿200") → 
		ArrResult(TypeRef(Reference("⌿definitions⌿User")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/plants⌿get⌿responses⌿200") → 
		ArrResult(TypeRef(Reference("⌿definitions⌿Plant")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/areas⌿get⌿responses⌿200") → 
		ArrResult(TypeRef(Reference("⌿definitions⌿Area")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿responses⌿200") → 
		ArrResult(Str(None, new TypeMeta(None, List())), new TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿responses⌿200") → 
		ArrResult(TypeRef(Reference("⌿definitions⌿Watering")), new TypeMeta(None, List()))
) 
 
 val parameters = Map[ParameterRef, Parameter](
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿user_id")) → Parameter("user_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿user_id")) → Parameter("user_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}⌿get⌿user_id")) → Parameter("user_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/areas/{area_id}⌿delete⌿area_id")) → Parameter("area_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿watering_id")) → Parameter("watering_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿user_id")) → Parameter("user_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿watering_id")) → Parameter("watering_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/areas/{area_id}⌿put⌿area_id")) → Parameter("area_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿picture_id")) → Parameter("picture_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/areas/{area_id}⌿get⌿area_id")) → Parameter("area_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}⌿put⌿user_id")) → Parameter("user_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}⌿delete⌿user_id")) → Parameter("user_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿picture_id")) → Parameter("picture_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿picture_id")) → Parameter("picture_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿user_id")) → Parameter("user_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿plant_id")) → Parameter("plant_id", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path"))
) 
...
val packageName: Option[String] = Some("type_deduplication.yaml")
