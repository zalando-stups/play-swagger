...
object string_formats_validation_yaml extends WithModel {
 ...
 val types = Map[Reference, Type](
	Reference("⌿paths⌿/string⌿post⌿string_optional") → 
		Opt(Str(None, new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), new TypeMeta(None, List())),
	Reference("⌿paths⌿/string⌿post⌿date_time_required") → 
		DateTime(new TypeMeta(None, List())),
	Reference("⌿paths⌿/string⌿post⌿date_required") → 
		Date(new TypeMeta(None, List())),
	Reference("⌿paths⌿/string⌿post⌿password_optional") → 
		Opt(Password(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), new TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/string⌿post⌿string_required") → 
		Str(None, new TypeMeta(None, List("""maxLength(100)""", """minLength(10)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))),
	Reference("⌿paths⌿/string⌿post⌿binary_optional") → 
		Opt(BinaryString(new TypeMeta(None, List("""maxLength(110)""", """minLength(10)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), new TypeMeta(None, List())),
	Reference("⌿paths⌿/string⌿post⌿password_required") → 
		Password(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))),
	Reference("⌿paths⌿/string2⌿post⌿binary_required") → 
		BinaryString(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))),
	Reference("⌿paths⌿/string⌿post⌿base64required") → 
		Base64String(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))),
	...
	Reference("⌿paths⌿/string⌿post⌿base64optional") → 
		Opt(Base64String(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), new TypeMeta(None, List())),
	Reference("⌿paths⌿/string2⌿post⌿responses⌿200") → 
		Null(new TypeMeta(None, List()))
) 
 
 val parameters = Map[ParameterRef, Parameter](
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿string_required")) → Parameter("string_required", Str(None, new TypeMeta(None, List("""maxLength(100)""", """minLength(10)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	ParameterRef(	Reference("⌿paths⌿/string2⌿post⌿binary_required")) → Parameter("binary_required", BinaryString(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), None, None, ".+", encode = false, ParameterPlace.withName("body")),
	...
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿date_required")) → Parameter("date_required", Date(new TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿base64required")) → Parameter("base64required", Base64String(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿date_time_required")) → Parameter("date_time_required", DateTime(new TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿password_required")) → Parameter("password_required", Password(new TypeMeta(None, List("""maxLength(10)""", """minLength(0)""", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), None, None, ".+", encode = true, ParameterPlace.withName("query")),
...
val packageName: Option[String] = Some("string_formats_validation.yaml")
