...
object split_petstore_api_yaml extends WithModel {
 ...
 val types = Map[Reference, Type](
	...
	Reference("⌿definitions⌿Order⌿complete") → 
		Opt(Bool(new TypeMeta(None, List())), new TypeMeta(None, List())),
	Reference("⌿definitions⌿Pet⌿tags") → 
		Opt(TypeRef(Reference("⌿definitions⌿Pet⌿tags⌿Opt")), new TypeMeta(None, List())),
	...
	Reference("⌿definitions⌿Pet⌿category") → 
		Opt(TypeRef(Reference("⌿definitions⌿Pet⌿category⌿Opt")), new TypeMeta(None, List())),
	Reference("⌿definitions⌿Pet⌿category⌿Opt") → 
		TypeDef(Reference("⌿definitions⌿Category"), 
			Seq(
					Field(Reference("⌿definitions⌿Category⌿id"), TypeRef(Reference("⌿definitions⌿Order⌿petId"))),
					Field(Reference("⌿definitions⌿Category⌿name"), TypeRef(Reference("⌿definitions⌿Order⌿status")))
	...
	Reference("⌿paths⌿/pets⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/pets⌿post⌿body⌿Opt")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{username}⌿put⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Opt")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/stores/order⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/stores/order⌿post⌿body⌿Opt")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/pets/{petId}⌿delete⌿petId") → 
		Lng(new TypeMeta(None, List())),
	Reference("⌿paths⌿/users/createWithList⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/users/createWithList⌿post⌿body⌿Opt")), new TypeMeta(None, List())),
	Reference("⌿paths⌿/pets/findByStatus⌿get⌿status") → 
		Opt(TypeRef(Reference("⌿paths⌿/pets/findByStatus⌿get⌿status⌿Opt")), new TypeMeta(None, List())),
	Reference("⌿definitions⌿Pet⌿tags⌿Opt") → 
		ArrResult(TypeRef(Reference("⌿definitions⌿Pet⌿category⌿Opt")), new TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/pets/findByStatus⌿get⌿status⌿Opt") → 
		Arr(Str(None, new TypeMeta(None, List())), new TypeMeta(None, List()), "multi"),
	Reference("⌿paths⌿/users/createWithList⌿post⌿body⌿Opt") → 
		Arr(TypeRef(Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Opt")), new TypeMeta(None, List()), "csv"),
	Reference("⌿paths⌿/pets/findByStatus⌿get⌿responses⌿200") → 
		ArrResult(TypeRef(Reference("⌿paths⌿/pets⌿post⌿body⌿Opt")), new TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Opt") → 
	...
	Reference("⌿paths⌿/stores/order⌿post⌿body⌿Opt") → 
 ...
 val parameters = Map[ParameterRef, Parameter](
	ParameterRef(	Reference("⌿paths⌿/pets/{petId}⌿get⌿petId")) → Parameter("petId", Lng(new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/pets/{petId}⌿post⌿name")) → Parameter("name", Str(None, new TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("formData")),
	...
	ParameterRef(	Reference("⌿paths⌿/stores/order/{orderId}⌿delete⌿orderId")) → Parameter("orderId", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/pets/{petId}⌿post⌿petId")) → Parameter("petId", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/pets/{petId}⌿delete⌿petId")) → Parameter("petId", Lng(new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/pets/{petId}⌿delete⌿api_key")) → Parameter("api_key", Str(None, new TypeMeta(None, List())), None, None, ".+", encode = false, ParameterPlace.withName("header")),
	...
	ParameterRef(	Reference("⌿paths⌿/users/{username}⌿put⌿username")) → Parameter("username", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/users/{username}⌿get⌿username")) → Parameter("username", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	ParameterRef(	Reference("⌿paths⌿/users/{username}⌿delete⌿username")) → Parameter("username", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path")),
	...
	ParameterRef(	Reference("⌿paths⌿/pets/{petId}⌿post⌿status")) → Parameter("status", Str(None, new TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("formData")),
	...
	ParameterRef(	Reference("⌿paths⌿/stores/order/{orderId}⌿get⌿orderId")) → Parameter("orderId", Str(None, new TypeMeta(None, List())), None, None, "[^/]+", encode = true, ParameterPlace.withName("path"))
) 
...
val packageName: Option[String] = Some("split.petstore.api.yaml")
