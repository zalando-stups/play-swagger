...
object uber_api_yaml extends WithModel {
 ...
 def types = Map[Reference, Type](
	...
	Reference("⌿paths⌿/estimates/time⌿get⌿customer_uuid") → 
		Opt(Str(Some("uuid"), TypeMeta(Some("uuid"), List())), TypeMeta(None, List())),
 ...
 def parameters = Map[ParameterRef, Parameter](
	...
	ParameterRef(	Reference("⌿paths⌿/estimates/time⌿get⌿customer_uuid")) → Parameter("customer_uuid", Opt(Str(Some("uuid"), TypeMeta(Some("uuid"), List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
